...
export default function AuthCheck() {
  ...
  useEffect(() => {
    ...
    const performAuthCheck = async () => {
      try {
        ...
        console.log(
          'AuthCheck: Evaluating onboarding status: hasCompletedOnboarding =',
  ...
  return (
    ...
    >
      <Text style={{ fontSize: 24, fontWeight: 'bold', color: '#FF4B6E', marginBottom: 15 }}>
        Welcome to Love Tiers!
      </Text>
      <ActivityIndicator size="large" color="#FF4B6E" />
      <Text style={{ marginTop: 20, color: '#555', textAlign: 'center', maxWidth: '80%' }}>
        Verifying your account...
      </Text>
      <Text
        style={{ marginTop: 10, color: '#888', textAlign: 'center', maxWidth: '80%', fontSize: 14 }}
      >
